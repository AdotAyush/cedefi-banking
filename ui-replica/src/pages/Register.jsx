...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) setSuccessData(result.user)
        ...
        <Card className="w-full max-w-lg">
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <div className="mt-1 p-2 bg-gray-50 border rounded font-mono text-xs break-all">{successData.did}</div>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700">Your Private Key</label>
              <div className="mt-1 p-2 bg-gray-50 border rounded font-mono text-xs break-all">{successData.privateKey}</div>
            </div>
